...
#         # 
#         tx =    torch.zeros(nA, nG_h, nG_w, 1)
#         ty =    torch.zeros(nA, nG_h, nG_w, 1)
#         tw =    torch.zeros(nA, nG_h, nG_w, 1)
#         th =    torch.zeros(nA, nG_h, nG_w, 1)
#         tconf = torch.zeros(nA, nG_h, nG_w, 1)
#         tcls =  torch.zeros(nA, nG_h, nG_w, nC)
#         # 
#         mask =  torch.zeros(nA, nG_h, nG_w)
#         conf_mask = torch.ones(nA, nG_h, nG_w)
#         # 
